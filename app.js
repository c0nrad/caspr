...
var allowCrossDomain = function(req, res, next) {
    ...
    res.header('Content-Security-Policy-Report-Only', "default-src 'none'; script-src 'self'; connect-src 'self'; img-src 'self'; style-src 'self'; font-src 'self'; report-uri http://localhost:3000/endpoint/d89dc57ebc6f1a5375aaeb0df0d7693f3170ece30a72cb58f0527ba4fe235e4e");
